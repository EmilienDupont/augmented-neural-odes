...
from experiments_2.tde.tde_model import TensorDiffEq
from experiments_2.tde.tde_training import TensorDiffEqTrainer
...
class ExperimentSphere:
    ...
    def train_tensor_ode(self, lr=1e-3, num_epochs=1000):
        ...
        self.tensor_diff_eq_trainer = TensorDiffEqTrainer(model=tensor_diff_eq_model, optimizer=optimizer,
                                                          data_loader=self.data_loader, device=self.device,
                                                          loss_func=loss_func, num_epochs=num_epochs, lr=1e-3, print_freq=10)
